...
import com.itenlee.search.analysis.core.TokenizerService;
...
public class AnalyzeContext {
    ...
    public AnalyzeContext(Reader reader, Configuration configuration) {
        this.input = reader;
        this.tokenizerService = new TokenizerService(configuration);
    ...
    public Term next() throws IOException {
        ...
        List<Term> termList = tokenizerService.segment(line);
        // 分词结果是空
        if (termList.size() == 0) {
            return null;
        }
